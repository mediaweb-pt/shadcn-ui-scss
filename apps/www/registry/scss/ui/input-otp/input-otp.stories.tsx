...
const templateSeparator = (args: any) => (
...
export const Separator: Story = {
  render: (args) => templateSeparator(args),
}
const templateControlled = (args: any) => {
...
const templateFormExample = (args: any) => {
  const form = useForm()
...
export const FormExample: Story = {
  render: (args) => templateFormExample(args),
}
