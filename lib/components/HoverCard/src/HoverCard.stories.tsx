...
import { Avatar, AvatarFallback, AvatarImage } from "../../Avatar/src"
                ...
                <div>
                    ...
                    <div className="margin-top-xs display-flex align-items-center padding-top-s">
                        <CalendarDays
                            ...
                            style={{ opacity: 0.7, height: "var(--font-size-base)", width: "var(--font-size-base)" }}
                        />
                        <span className="font-size-xs text-neutral-7">Joined December 2021</span>
                    </div>
                </div>
            </div>
        </HoverCardContent>
