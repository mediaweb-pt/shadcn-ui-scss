...
>(({ className, children, ...props }, ref) => (
    <ScrollAreaPrimitive.Root ref={ref} className={cn("scroll-area", className)}  style={{"--_scroll-area-width": "192px", "--_scroll-area-height": "288px" } as React.CSSProperties} {...props}>
