...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "../../Select/src"
            ...
            <CardContent className="display-grid gap-base">
                <div className="display-flex align-items-center gap-base border-size-s border-radius-soft padding-base">
                    ...
                    <div className="flex1">
                        ...
                        <p className="margin-top-xs font-size-s text-neutral-7">Send notifications to device.</p>
                    </div>
                    <Switch />
                </div>
                <div>
                    {notifications.map((notification, index) => (
                        <div
                            ...
                            className={cn("display-flex gap-base", {
                                "margin-bottom-base padding-bottom-base": index < notifications.length - 1,
                            })}
                        >
                            <span
                            ...
                            <div>
                                ...
                                <p className="margin-top-xs font-size-s text-neutral-7">{notification.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
