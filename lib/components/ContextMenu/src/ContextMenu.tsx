...
>(({ className, inset, children, ...props }, ref) => (
    <ContextMenuPrimitive.SubTrigger
        ref={ref}
        className={cn("context-menu-subTrigger", inset && "padding-left-l", className)}
        {...props}
    >
        {children}
...
>(({ className, ...props }, ref) => (
    <ContextMenuPrimitive.SubContent ref={ref} className={cn("context-menu-subContent", className)} {...props} />
))
