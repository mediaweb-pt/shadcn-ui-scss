...
>(({ className, ...props }, ref) => <MenubarPrimitive.Root ref={ref} className={cn("menubar", className)} {...props} />)
...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.SubContent ref={ref} className={cn("menubar-subContent", className)} {...props} />
))
...
>(({ className, inset, ...props }, ref) => (
    <MenubarPrimitive.Item ref={ref} className={cn("menubar-item", inset && "padding-left-l", className)} {...props} />
))
...
>(({ className, children, ...props }, ref) => (
    <MenubarPrimitive.RadioItem ref={ref} className={cn("menubar-item-radio", className)} {...props}>
        <span>
            <MenubarPrimitive.ItemIndicator>
                <Circle />
            </MenubarPrimitive.ItemIndicator>
