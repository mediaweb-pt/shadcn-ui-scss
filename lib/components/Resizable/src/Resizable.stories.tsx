...
export const Default: Story = {
    render: () => (
        <ResizablePanelGroup direction="horizontal" className="border-radius-soft border-size-s">
...
export const Vertical: Story = {
    render: () => (
        <ResizablePanelGroup direction="vertical" className="border-radius-soft border-size-s">
            <ResizablePanel defaultSize={25}>
                <div className="display-flex full-height align-items-center justify-content-center padding-m">
