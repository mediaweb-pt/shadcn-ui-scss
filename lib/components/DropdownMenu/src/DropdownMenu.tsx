...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.Trigger ref={ref} className={cn("dropdown-menu-trigger", className)} {...props} />
))
...
>(({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
        ref={ref}
        className={cn("dropdown-menu-subTrigger", inset && "padding-left-m", className)}
        {...props}
    >
        {children}
...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent ref={ref} className={cn("dropdown-menu-subContent", className)} {...props} />
))
...
>(({ className, children, ...props }, ref) => (
    <DropdownMenuPrimitive.RadioItem ref={ref} className={cn("dropdown-menu-radioItem", className)} {...props}>
