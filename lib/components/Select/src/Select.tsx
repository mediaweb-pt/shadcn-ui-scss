...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollUpButton ref={ref} className={cn("select-scrollUpButton", className)} {...props}>
        <ChevronUp />
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollDownButton ref={ref} className={cn("select-scrollDownButton", className)} {...props}>
        <ChevronDown />
