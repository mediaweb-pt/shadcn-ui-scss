...
>(({ className, children, ...props }, ref) => (
    <NavigationMenuPrimitive.Trigger ref={ref} className={cn(navigationMenuTriggerStyle(), className)} {...props}>
        {children} <ChevronDown className="navigation-menu-icon" aria-hidden="true" />
...
>(({ className, ...props }, ref) => (
    <div className={cn("navigation-menu-viewportWrapper")}>
        <NavigationMenuPrimitive.Viewport className={cn("navigation-menu-viewport", className)} ref={ref} {...props} />
    </div>
))
