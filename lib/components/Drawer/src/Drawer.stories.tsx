...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from "../../Dialog/src"
                    ...
                    <div className="padding-x-base padding-top-base">
                        <div className="display-flex align-items-center justify-content-center gap-s">
                            ...
                            <div className="flex1 text-align-center">
                                <div className="font-bold" style={{ fontSize: 72, lineHeight: 1 }}>
                                    {goal}
                                </div>
                                <div className="font-size-xs text-uppercase text-neutral-7">Calories/day</div>
                            </div>
                            <Button
                                variant="outline"
                                size="icon"
