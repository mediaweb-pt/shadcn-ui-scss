...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "../../DropdownMenu/src"
                ...
                <BreadcrumbList>
                    ...
                    {items.slice(-ITEMS_TO_DISPLAY + 1).map((item, index) => (
                        <BreadcrumbItem key={index}>
                            {item.href ? (
                                <>
                                    <BreadcrumbLink asChild className="text-ellipsis" style={{ maxWidth: 20 }}>
                                        <a href={item.href}>{item.label}</a>
                                    </BreadcrumbLink>
                                    <BreadcrumbSeparator />
                                </>
                            ) : (
                                <BreadcrumbPage className="text-ellipsis" style={{ maxWidth: 20 }}>
                                    {item.label}
                                </BreadcrumbPage>
                            )}
                        </BreadcrumbItem>
